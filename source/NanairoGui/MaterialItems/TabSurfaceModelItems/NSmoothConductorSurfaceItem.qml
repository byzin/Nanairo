...
Rectangle {
  ...
  NRefractiveIndexSettingBlock {
    ...
    refractiveIndexKey: Nanairo.outerRefractiveIndex
    labelText: qsTr("Outer refractive index")
  }

  NComplexRefractiveIndexSettingBlock {
    ...
    refractiveIndexKey: Nanairo.innerRefractiveIndex
    extinctionKey: Nanairo.innerExtinction
