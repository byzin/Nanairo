...
Rectangle {
  ...
  NStandardIlluminationSettingBlock {
    id: standard_illumination_setting_block
    x: standard_observer_setting_block.x
    y: (standard_observer_setting_block.y + standard_observer_setting_block.height) + Nanairo.blockOffset
    color: color_tab_item.color
  }

  NWavelengthSamplingSettingBlock {
    id: wavelength_sampling_setting_block
    x: standard_illumination_setting_block.x
    y: (standard_illumination_setting_block.y + standard_illumination_setting_block.height) + Nanairo.blockOffset
    color: color_tab_item.color
  }
  ...
  function getSceneData() {
    ...
    dataList.push(standard_observer_setting_block.getSceneData()); 
    dataList.push(standard_illumination_setting_block.getSceneData()); 
  ...
  function setSceneData(sceneData) {
    ...
    standard_observer_setting_block.setSceneData(sceneData);
    standard_illumination_setting_block.setSceneData(sceneData);
